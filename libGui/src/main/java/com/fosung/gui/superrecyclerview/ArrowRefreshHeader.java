...
public class ArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader {
	...
	private void initView() {
		...
		mContainer = (LinearLayout) LayoutInflater.from(getContext()).inflate(
				R.layout.gui_superrecyclerview_header, null);
	...
	public void setState(int state) {
		...
		switch(state){
            case STATE_NORMAL:
                ...
                mStatusTextView.setText(R.string.srv_listview_header_hint_normal);
                break;
            case STATE_RELEASE_TO_REFRESH:
                if (mState != STATE_RELEASE_TO_REFRESH) {
                    mArrowImageView.clearAnimation();
                    mArrowImageView.startAnimation(mRotateUpAnim);
                    mStatusTextView.setText(R.string.srv_listview_header_hint_release);
                }
                break;
            case     STATE_REFRESHING:
                mStatusTextView.setText(R.string.srv_refreshing);
                break;
            case    STATE_DONE:
                mStatusTextView.setText(R.string.srv_refresh_done);
                break;
            default:
		}
