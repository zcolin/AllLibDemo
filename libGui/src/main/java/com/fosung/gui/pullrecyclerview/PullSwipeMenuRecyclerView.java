...
import com.fosung.gui.pullrecyclerview.swipemenu.SwipeMenuLayout;
import com.fosung.gui.pullrecyclerview.swipemenu.SwipeMenuRecyclerView;
...
public class PullSwipeMenuRecyclerView extends PullRecyclerView {
    ...
    public PullSwipeMenuRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs, R.layout.gui_view_swipemenu_pullrecycler);
