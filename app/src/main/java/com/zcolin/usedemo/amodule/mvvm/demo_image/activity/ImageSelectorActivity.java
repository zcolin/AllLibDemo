...
package com.zcolin.usedemo.amodule.mvvm.demo_image.activity;
...
import com.zcolin.usedemo.amodule.mvvm.demo_image.presenter.ImageSelectorPresenter;
    ...
    protected void initView() {
        ...
        if (button != null) {
            button.setOnClickListener(view -> PermissionHelper.requestPermission(mActivity, new String[]{Manifest.permission.CAMERA, Manifest.permission
                    .READ_EXTERNAL_STORAGE}, new PermissionsResultAction() {
                @Override
